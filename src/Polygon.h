...
/*
    Abstração sobre polígonos da CANVAS.
    Permite acessar o polígonos a partir de seus segmentos de reta;
    Permite escolher se o poligono será preenchido ou não;
    Permite definir um texto para o polígono;
    Operações básicas: rotate, translate, scale;
*/
